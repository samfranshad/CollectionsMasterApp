    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            var numArray = numberList.ToArray();
        ...
        private static void NumberChecker(List<int> numberList)
        {
            ...
            bool canParse = int.TryParse(Console.ReadLine(), out int userNumber);
            

            while(canParse == false)
            {
                Console.WriteLine("Invalid input, please enter a number");
                canParse = canParse = int.TryParse(Console.ReadLine(), out userNumber);
            }
